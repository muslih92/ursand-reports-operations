...
import { LayoutDashboard, ClipboardList, AlertTriangle, Building2, FileText, Users, LogOut, Languages, FileSpreadsheet, Activity, Flame, Zap, ClipboardCheck, TrendingUp, MessageSquare, Radio, ShieldCheck, BarChart3, ShieldAlert, ListChecks, AlertOctagon } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { to: "/messages", icon: MessageSquare, key: "nav.messages", hideForOperator: true },
  { to: "/checklist", icon: ListChecks, key: "nav.checklist" },
  { to: "/station-notes", icon: AlertOctagon, key: "nav.stationNotes" },
